...
Write-Host "🛑 Stopping TCG Marketplace development infrastructure..." -ForegroundColor Yellow
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "💰 This will save ~$1.58/day in AWS costs" -ForegroundColor Green
